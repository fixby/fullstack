...
- Save the report to .openclaw/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.openclaw', 'security-reports');
...
- Skip the preamble (openclaw-update-check, telemetry, etc.) — go straight to the audit.
