...
const scriptPath = join(import.meta.dir, "..", "bin", "openclaw-global-discover.ts");

describe("openclaw-global-discover", () => {
  describe("normalizeRemoteUrl", () => {
    // Dynamically import to test the exported function
    let normalizeRemoteUrl: (url: string) => string;

    beforeEach(async () => {
      const mod = await import("../bin/openclaw-global-discover.ts");
