...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  // Ship
  'ship-base-branch': ['ship/**', 'bin/openclaw-repo-mode'],
  ...
  // Global discover
  'global-discover':   ['bin/openclaw-global-discover.ts', 'test/global-discover.test.ts'],
  ...
  'codex-review-findings': ['review/**', '.agents/skills/fullstack-review/**', 'codex/**', 'test/helpers/codex-session-runner.ts'],

  // Gemini E2E (tests skills via Gemini CLI)
  'gemini-discover-skill':  ['.agents/skills/**', 'test/helpers/gemini-session-runner.ts'],
  'gemini-review-findings': ['review/**', '.agents/skills/fullstack-review/**', 'test/helpers/gemini-session-runner.ts'],


  // Coverage audit (shared fixture) + triage
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/openclaw-repo-mode'],
  ...
  'ship-triage': ['ship/**', 'bin/openclaw-repo-mode'],
  ...
  // fullstack-upgrade
  'fullstack-upgrade-happy-path': ['fullstack-upgrade/**'],
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'fullstack-upgrade/SKILL.md upgrade flow': ['fullstack-upgrade/SKILL.md', 'fullstack-upgrade/SKILL.md.tmpl'],
};
