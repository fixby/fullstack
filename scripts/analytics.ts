#!/usr/bin/env bun
/**
 * analytics — CLI for viewing fullstack skill usage statistics.
 *
 * Reads ~/.openclaw/analytics/skill-usage.jsonl and displays:
...
const ANALYTICS_FILE = path.join(os.homedir(), '.openclaw', 'analytics', 'skill-usage.jsonl');
